...
CREATE TABLE IF NOT EXISTS customers(
        ...
        const string transHedQuery = @"
CREATE TABLE IF NOT EXISTS trans_hed(
        ...
        const string transDetQuery = @"
CREATE TABLE IF NOT EXISTS trans_det(
    ...
    dtrn_date_exp datetime NULL)   ";
        ...
        public static void CreateDatabase(Context ctx)
        {
            ...
            try
            {
                ...
                PreparedStatement = DBConnection.PrepareStatement(usersQuery);
                PreparedStatement.Execute();
                PreparedStatement.Close();

                // Create Items table
                PreparedStatement = DBConnection.PrepareStatement(itemsQuery);
                PreparedStatement.Execute();
                PreparedStatement.Close();

                // Create Customers table
                PreparedStatement = DBConnection.PrepareStatement(customersQuery);
                PreparedStatement.Execute();
                PreparedStatement.Close();

                // Create TransHed table
                PreparedStatement = DBConnection.PrepareStatement(transHedQuery);
                PreparedStatement.Execute();
                PreparedStatement.Close();

                // Create TransDet table
                PreparedStatement = DBConnection.PrepareStatement(transDetQuery);
                PreparedStatement.Execute();
                PreparedStatement.Close();
                //IF NOT EXISTS 

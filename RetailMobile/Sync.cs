...
");
	...
	");
		...
		public static void GenerateDatabase(Context ctx)
		{
			...
			try {
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE IF NOT EXISTS  rcustomer (
	id INTEGER NOT NULL,
	cst_cod VARCHAR(40) NOT NULL,
	cst_desc VARCHAR(120) NOT NULL,
	...
	PRIMARY KEY ( id ASC )
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE IF NOT EXISTS  rdisc (
...
CREATE TABLE IF NOT EXISTS  ritem_categ2 (
	...
	PRIMARY KEY ( id ASC, item_id ASC )
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE IF NOT EXISTS  ritems (
	id INTEGER NOT NULL,
	item_desc VARCHAR(120) NOT NULL,
	...
	PRIMARY KEY ( id ASC )
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE IF NOT EXISTS  rstatistic (
	cst_id INTEGER NOT NULL,
	...
	PRIMARY KEY ( trus_id ASC )
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE IF NOT EXISTS  rtrans_det (
	id INTEGER NOT NULL DEFAULT AUTOINCREMENT,
	...
	PRIMARY KEY ( id ASC )
				...
				PreparedStatement = DBConnection.PrepareStatement (@"CREATE TABLE  IF NOT EXISTS rtrans_hed (
	id INTEGER NOT NULL DEFAULT AUTOINCREMENT,

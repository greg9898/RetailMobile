...
namespace RetailMobile
{
	public class CheckableItemsAdapter : ArrayAdapter<Library.ItemInfo>
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			//dobaveno dtrn_qty_left
			//premahnati ret_val i buy_val - raboti samo s 1 cena - sale
			//tbItemRetVal.Text = item.item_ret_val1.ToString(PreferencesUtil.DecimalFormat);
			tbItemRetVal.Text = item.item_qty_left.ToString(PreferencesUtil.DecimalFormat);
